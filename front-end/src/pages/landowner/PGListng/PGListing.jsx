...
import { listPayingGuest } from "../../../api/payingGuest/payingGuest";
...
function PGListing() {
  ...
  const handleProvinceChange = (e) => {
    ...
    setSector(""); // Reset sector when province changes
  };
  ...
  const postPayingGuest = async () => {
    ...
    data.append("floorNumber", floorNumber);
    ...
    const response = await listPayingGuest(data);
    setLoading(true);
  ...
  return (
    <div className="flex flex-col items-center min-h-screen px-4 pt-20 pb-4">
      <div className="w-[60%] p-6 bg-white">
        <h2 className="mb-4 text-2xl font-bold">List your paying guest</h2>
        <div className="mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          ...
          <div className="relative">
            ...
            <select
              ...
              disabled={!province}
              className={`w-full p-3 mt-1 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primaryColor focus:border-transparent appearance-none
                ${!province ? 'cursor-not-allowed opacity-60' : 'cursor-pointer'}`}
            >
              <option value="">Select City</option>
              {province && CITIES_BY_PROVINCE[province].map(cityName => (
