...
import { UpdatePropertyBooking } from "../../api/propertyBooking/propertyBooking";

function PropertyPaymentSuccess() {
  ...
  useEffect(() => {
    async function updateBookingService() {
      if (sessionId) {
        try {
            await UpdatePropertyBooking(sessionId);
        } catch (error) {
...
export default PropertyPaymentSuccess;
