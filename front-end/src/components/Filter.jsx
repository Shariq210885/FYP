    ...
    <div className="w-full">
      {activeButton === "Rent" && (
        <div className="relative">
          <div className="grid items-center grid-cols-5 py-1 mx-auto text-sm tracking-wide border-2 border-gray-700 rounded-full w-[80%]">
          ...
          {showAdvancedFilters && (
            <div
              ...
              className="absolute z-20 mt-2 w-[80%] left-[10%] bg-white border-2 border-gray-300 rounded-lg shadow-lg py-4 px-6"
            >
